import type { ForgeWorkspace, ForgeNode } from "./types.js";
import { inferTags, nowIso, uuid } from "./utils.js";

function makeNode(partial: Pick<ForgeNode, "kind" | "title" | "content" | "x" | "y"> & { url?: string; imageData?: string; lamport: number }): ForgeNode {
...
export function createSampleWorkspace(): ForgeWorkspace {
  const nodes = [
    makeNode({
      kind: "note",
